...
<ul class="icons">
				...
				{% endif %}
				{% if site.blog_url %}
                                <li><a href="{{ site.blog_url }}" class="fa-brands fa-blogger" target="_blank"><span class="label">Blog</span></a></li>
                                {% endif %}
				{% if site.youtube_url %}
                                <li><a href="{{ site.youtube_url }}" class="fa-brands fa-youtube" target="_blank"><span class="label">YouTube</span></a></li>
                                {% endif %}
</ul>
